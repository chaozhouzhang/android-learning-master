...
/**
 * Created on 2019/3/5 13:33
 *
 * @author zhangchaozhou
 */
public class Utils {

    /** 获取应用签名:debug(0)或者release(1)
     * @param
     */
    public static String getAppSign(Context context){
        ...
        if(isDebuggable(context)){
            appSign = getSignature(context)+"/"+0;
        }else{
            appSign = getSignature(context)+"/"+1;
        }
    ...
    public static final String getUserAgent(Context context) {
        ...
        builder.append(getOldUserAgent(context));
    ...
    public static String decrypt(String key, String initVector, String encrypted) {
        try {
            ...
            byte[] original = cipher.doFinal(Base64.getDecoder().decode(encrypted.replace("\r\n", "")));
